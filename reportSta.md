...
<!--html_preserve--><div class="plotly html-widget html-widget-output shiny-report-size shiny-report-theme html-fill-item" id="staApp_1-oute7e34e06d600d23f" style="width:100%;height:400px;"></div><!--/html_preserve-->
...
<!--html_preserve--><div class="datatables html-widget html-widget-output shiny-report-size html-fill-item" id="staApp_1-out0ba5145aeef1af27" style="width:100%;height:auto;"></div><!--/html_preserve-->
...
<!--html_preserve--><div class="datatables html-widget html-widget-output shiny-report-size html-fill-item" id="staApp_1-out05157b7747e239da" style="width:100%;height:auto;"></div><!--/html_preserve-->
...
<div>
<select id="staApp_1-traitStaFieldView" class="shiny-input-select"><option value="Ear_Height_cm" selected>Ear_Height_cm</option>
<option value="Plant_Height_cm">Plant_Height_cm</option>
<option value="Yield_Mg_ha">Yield_Mg_ha</option></select>
...
<!--html_preserve--><div class="plotly html-widget html-widget-output shiny-report-size shiny-report-theme html-fill-item" id="staApp_1-out828ffe65d19e39ca" style="width:100%;height:400px;"></div><!--/html_preserve-->
...
<!--html_preserve--><div class="plotly html-widget html-widget-output shiny-report-size shiny-report-theme html-fill-item" id="staApp_1-out3d40a997d1088f5f" style="width:100%;height:400px;"></div><!--/html_preserve-->
...
<div>
<select id="staApp_1-parameterMetrics" class="shiny-input-select"><option value="mean_designation" selected>mean_designation</option>
<option value="plotH2_designation">plotH2_designation</option>
<option value="r2_designation">r2_designation</option></select>
...
<div>
<div class="form-group shiny-input-container">
<label class="control-label" id="staApp_1-parameterMetricsBy-label" for="staApp_1-parameterMetricsBy">View by:</label>
<div>
<select id="staApp_1-parameterMetricsBy" class="shiny-input-select"><optgroup label="All">
...
<!--html_preserve--><div class="plotly html-widget html-widget-output shiny-report-size shiny-report-theme html-fill-item" id="staApp_1-outeafc16326aca49e1" style="width:100%;height:400px;"></div><!--/html_preserve-->
...
<!--html_preserve--><div class="datatables html-widget html-widget-output shiny-report-size html-fill-item" id="staApp_1-outee063813790cf014" style="width:100%;height:auto;"></div><!--/html_preserve-->
...
<!--html_preserve--><div class="datatables html-widget html-widget-output shiny-report-size html-fill-item" id="staApp_1-outee2b6bb4ec1d74d8" style="width:100%;height:auto;"></div><!--/html_preserve-->
...
<!--html_preserve--><div class="plotly html-widget html-widget-output shiny-report-size shiny-report-theme html-fill-item" id="staApp_1-out9f4ede4bd767cf45" style="width:100%;height:400px;"></div><!--/html_preserve-->
...
<div>
<div class="form-group shiny-input-container">
<label class="control-label" id="staApp_1-traitStaCompEnv-label" for="staApp_1-traitStaCompEnv">Environment to filter:</label>
<div>
...
<!--html_preserve--><div class="plotly html-widget html-widget-output shiny-report-size shiny-report-theme html-fill-item" id="staApp_1-out26df783dc8acc1ef" style="width:100%;height:400px;"></div><!--/html_preserve-->
...
<div class="checkbox">
<label>
<input id="staApp_1-freqCor" type="checkbox" class="shiny-input-checkbox" checked="checked"/>
...
<!--html_preserve--><div class="plotly html-widget html-widget-output shiny-report-size shiny-report-theme html-fill-item" id="staApp_1-out7745525f956f651a" style="width:100%;height:400px;"></div><!--/html_preserve-->
</div>
